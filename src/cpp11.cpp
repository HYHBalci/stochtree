...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_stochtree_updateLinearTreatmentCpp_cpp",                        (DL_FUNC) &_stochtree_updateLinearTreatmentCpp_cpp,                        18},
