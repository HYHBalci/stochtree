...
create_uplift_forest_dataset_cpp <- function() {
  .Call(`_stochtree_create_uplift_forest_dataset_cpp`)
}
...
forest_dataset_add_treatment_cpp <- function(dataset_ptr, treatment) {
  invisible(.Call(`_stochtree_forest_dataset_add_treatment_cpp`, dataset_ptr, treatment))
}
...
horseshoe_logit_step_cpp <- function(X, y_star, weights, omega_in, beta_in, lambda_sq_in, tau_sq, nu_in, xi) {
  .Call(`_stochtree_horseshoe_logit_step_cpp`, X, y_star, weights, omega_in, beta_in, lambda_sq_in, tau_sq, nu_in, xi)
}
...
updateLinearTreatmentCpp_cpp <- function(X_design, XtX_design, X, Z, propensity_train, residual, are_continuous, alpha, beta, beta_int, tau_beta, nu, xi, tau_int, sigma, alpha_prior_sd, tau_glob, sample_global_prior, unlink, gibbs, save_output, index, max_steps, step_out, propensity_seperate, regularize_ATE, hn_scale) {
  .Call(`_stochtree_updateLinearTreatmentCpp_cpp`, X_design, XtX_design, X, Z, propensity_train, residual, are_continuous, alpha, beta, beta_int, tau_beta, nu, xi, tau_int, sigma, alpha_prior_sd, tau_glob, sample_global_prior, unlink, gibbs, save_output, index, max_steps, step_out, propensity_seperate, regularize_ATE, hn_scale)
}

updateLinearTreatmentCpp_NCP_cpp <- function(X_design, XtX_design, X, Z, propensity_train, residual, are_continuous, alpha_tilde, beta_tilde, beta_int_tilde, tau_beta, nu, xi, tau_int, sigma, alpha_prior_sd, tau_glob, sample_global_prior, unlink, gibbs, save_output, index, max_steps, step_out, propensity_seperate, regularize_ATE, hn_scale) {
  .Call(`_stochtree_updateLinearTreatmentCpp_NCP_cpp`, X_design, XtX_design, X, Z, propensity_train, residual, are_continuous, alpha_tilde, beta_tilde, beta_int_tilde, tau_beta, nu, xi, tau_int, sigma, alpha_prior_sd, tau_glob, sample_global_prior, unlink, gibbs, save_output, index, max_steps, step_out, propensity_seperate, regularize_ATE, hn_scale)
}
...
updateLinearTreatmentCpp_amr <- function(obs_weights, X_design, XtX_design, X, Z, propensity_train, residual, are_continuous, alpha, beta, beta_int, tau_beta, nu, xi, tau_int, sigma, alpha_prior_sd, tau_glob, sample_global_prior, unlink, gibbs, save_output, index, max_steps, step_out, propensity_seperate, regularize_ATE, hn_scale) {
  .Call(`_stochtree_updateLinearTreatmentCpp_amr`, obs_weights, X_design, XtX_design, X, Z, propensity_train, residual, are_continuous, alpha, beta, beta_int, tau_beta, nu, xi, tau_int, sigma, alpha_prior_sd, tau_glob, sample_global_prior, unlink, gibbs, save_output, index, max_steps, step_out, propensity_seperate, regularize_ATE, hn_scale)
}

updateLinearTreatmentCpp_NCP_amr <- function(X_design, XtX_design, X, Z, propensity_train, residual, obs_weights, are_continuous, alpha_tilde, beta_tilde, beta_int_tilde, tau_beta, nu, xi, tau_int, sigma, alpha_prior_sd, tau_glob, sample_global_prior, unlink, gibbs, save_output, index, max_steps, step_out, propensity_seperate, regularize_ATE, hn_scale) {
  .Call(`_stochtree_updateLinearTreatmentCpp_NCP_amr`, X_design, XtX_design, X, Z, propensity_train, residual, obs_weights, are_continuous, alpha_tilde, beta_tilde, beta_int_tilde, tau_beta, nu, xi, tau_int, sigma, alpha_prior_sd, tau_glob, sample_global_prior, unlink, gibbs, save_output, index, max_steps, step_out, propensity_seperate, regularize_ATE, hn_scale)
}

updateLinearTreatmentCpp_cpp_old <- function(X_design, XtX_design, X, Z, propensity_train, residual, are_continuous, alpha, beta, beta_int, tau_beta, nu, xi, tau_int, sigma, alpha_prior_sd, tau_glob, sample_global_prior, unlink, gibbs, save_output, index, max_steps, step_out, propensity_seperate, regularize_ATE, hn_scale) {
  .Call(`_stochtree_updateLinearTreatmentCpp_cpp_old`, X_design, XtX_design, X, Z, propensity_train, residual, are_continuous, alpha, beta, beta_int, tau_beta, nu, xi, tau_int, sigma, alpha_prior_sd, tau_glob, sample_global_prior, unlink, gibbs, save_output, index, max_steps, step_out, propensity_seperate, regularize_ATE, hn_scale)
}

updateLinearTreatmentCpp_NCP_cpp_old <- function(X_design, XtX_design, X, Z, propensity_train, residual, are_continuous, alpha_tilde, beta_tilde, beta_int_tilde, tau_beta, nu, xi, tau_int, sigma, alpha_prior_sd, tau_glob, sample_global_prior, unlink, gibbs, save_output, index, max_steps, step_out, propensity_seperate, regularize_ATE, hn_scale) {
  .Call(`_stochtree_updateLinearTreatmentCpp_NCP_cpp_old`, X_design, XtX_design, X, Z, propensity_train, residual, are_continuous, alpha_tilde, beta_tilde, beta_int_tilde, tau_beta, nu, xi, tau_int, sigma, alpha_prior_sd, tau_glob, sample_global_prior, unlink, gibbs, save_output, index, max_steps, step_out, propensity_seperate, regularize_ATE, hn_scale)
}
