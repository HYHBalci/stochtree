...
updateLinearTreatmentCpp_cpp <- function(X_design, XtX_design, X, Phi, Z, propensity_train, residual, are_continuous, alpha, gamma_prop, beta, beta_int, gamma, tau_beta, tau_gamma, nu, nu_gamma, xi, tau_int, sigma, alpha_prior_sd, tau_glob, sample_global_prior, unlink, gibbs, save_output, index, max_steps, step_out, propensity_seperate, regularize_ATE, hn_scale, use_prognostic_shapley) {
  .Call(`_stochtree_updateLinearTreatmentCpp_cpp`, X_design, XtX_design, X, Phi, Z, propensity_train, residual, are_continuous, alpha, gamma_prop, beta, beta_int, gamma, tau_beta, tau_gamma, nu, nu_gamma, xi, tau_int, sigma, alpha_prior_sd, tau_glob, sample_global_prior, unlink, gibbs, save_output, index, max_steps, step_out, propensity_seperate, regularize_ATE, hn_scale, use_prognostic_shapley)
}

updateLinearTreatmentCpp_NCP_cpp <- function(X_design, XtX_design, X, Phi, Z, propensity_train, residual, are_continuous, alpha_tilde, gamma_prop, beta_tilde, beta_int_tilde, gamma_tilde, tau_beta, tau_gamma, nu, nu_gamma, xi, tau_int, sigma, alpha_prior_sd, tau_glob, sample_global_prior, unlink, gibbs, save_output, index, max_steps, step_out, propensity_seperate, regularize_ATE, hn_scale, use_prognostic_shapley) {
  .Call(`_stochtree_updateLinearTreatmentCpp_NCP_cpp`, X_design, XtX_design, X, Phi, Z, propensity_train, residual, are_continuous, alpha_tilde, gamma_prop, beta_tilde, beta_int_tilde, gamma_tilde, tau_beta, tau_gamma, nu, nu_gamma, xi, tau_int, sigma, alpha_prior_sd, tau_glob, sample_global_prior, unlink, gibbs, save_output, index, max_steps, step_out, propensity_seperate, regularize_ATE, hn_scale, use_prognostic_shapley)
}
...
updateLinearTreatmentCpp_amr <- function(obs_weights, X_design, XtX_design, X, Z, propensity_train, residual, are_continuous, alpha, gamma, beta, beta_int, tau_beta, nu, xi, tau_int, sigma, alpha_prior_sd, tau_glob, sample_global_prior, unlink, gibbs, save_output, index, max_steps, step_out, propensity_seperate, regularize_ATE, hn_scale) {
  .Call(`_stochtree_updateLinearTreatmentCpp_amr`, obs_weights, X_design, XtX_design, X, Z, propensity_train, residual, are_continuous, alpha, gamma, beta, beta_int, tau_beta, nu, xi, tau_int, sigma, alpha_prior_sd, tau_glob, sample_global_prior, unlink, gibbs, save_output, index, max_steps, step_out, propensity_seperate, regularize_ATE, hn_scale)
}

updateLinearTreatmentCpp_NCP_amr <- function(X_design, XtX_design, X, Z, propensity_train, residual, obs_weights, are_continuous, alpha_tilde, gamma, beta_tilde, beta_int_tilde, tau_beta, nu, xi, tau_int, sigma, alpha_prior_sd, tau_glob, sample_global_prior, unlink, gibbs, save_output, index, max_steps, step_out, propensity_seperate, regularize_ATE, hn_scale) {
  .Call(`_stochtree_updateLinearTreatmentCpp_NCP_amr`, X_design, XtX_design, X, Z, propensity_train, residual, obs_weights, are_continuous, alpha_tilde, gamma, beta_tilde, beta_int_tilde, tau_beta, nu, xi, tau_int, sigma, alpha_prior_sd, tau_glob, sample_global_prior, unlink, gibbs, save_output, index, max_steps, step_out, propensity_seperate, regularize_ATE, hn_scale)
}

updateLinearTreatmentCpp_cpp_old <- function(X_design, XtX_design, X, Z, propensity_train, residual, are_continuous, alpha, gamma, beta, beta_int, tau_beta, nu, xi, tau_int, sigma, alpha_prior_sd, tau_glob, sample_global_prior, unlink, gibbs, save_output, index, max_steps, step_out, propensity_seperate, regularize_ATE, hn_scale) {
  .Call(`_stochtree_updateLinearTreatmentCpp_cpp_old`, X_design, XtX_design, X, Z, propensity_train, residual, are_continuous, alpha, gamma, beta, beta_int, tau_beta, nu, xi, tau_int, sigma, alpha_prior_sd, tau_glob, sample_global_prior, unlink, gibbs, save_output, index, max_steps, step_out, propensity_seperate, regularize_ATE, hn_scale)
}

updateLinearTreatmentCpp_NCP_cpp_old <- function(X_design, XtX_design, X, Z, propensity_train, residual, are_continuous, alpha_tilde, gamma, beta_tilde, beta_int_tilde, tau_beta, nu, xi, tau_int, sigma, alpha_prior_sd, tau_glob, sample_global_prior, unlink, gibbs, save_output, index, max_steps, step_out, propensity_seperate, regularize_ATE, hn_scale) {
  .Call(`_stochtree_updateLinearTreatmentCpp_NCP_cpp_old`, X_design, XtX_design, X, Z, propensity_train, residual, are_continuous, alpha_tilde, gamma, beta_tilde, beta_int_tilde, tau_beta, nu, xi, tau_int, sigma, alpha_prior_sd, tau_glob, sample_global_prior, unlink, gibbs, save_output, index, max_steps, step_out, propensity_seperate, regularize_ATE, hn_scale)
}
