...
updateLinearTreatmentCpp_cpp <- function(X, Z, propensity_train, residual, are_continuous, alpha, gamma, beta, beta_int, tau_beta, nu, xi, tau_int, sigma, alpha_prior_sd, tau_glob, global_shrink, unlink, gibbs, save_output, index, max_steps, step_out, propensity_seperate) {
  .Call(`_stochtree_updateLinearTreatmentCpp_cpp`, X, Z, propensity_train, residual, are_continuous, alpha, gamma, beta, beta_int, tau_beta, nu, xi, tau_int, sigma, alpha_prior_sd, tau_glob, global_shrink, unlink, gibbs, save_output, index, max_steps, step_out, propensity_seperate)
}
